...
import java.util.ArrayList;
    ...
    public class DBManager {
        ...
        /*
        Returneaza un ArrayList cu obiecte de tip servlets.StudentNotaMaterie reprezentand liniile din interogarea din resultSet.
        In cazul in care in select se afla o coloana nula si atribtuul din obiectul ce reprezinta coloana respectiva va fi null.
        De exemplu, Silviu Stan are coloana grupa nula, deci servlets.Student.grupa va fi null
         */
        ...
        /*
        Primeste o conexiune SQL si un obiect de tip servlets.Student, un String ce reprezinta id-ul materiei si un obiect de tip servlets.Nota.
